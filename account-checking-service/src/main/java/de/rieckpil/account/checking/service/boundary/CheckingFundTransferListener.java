...
@MessageDriven(activationConfig = {
    @ActivationConfigProperty(propertyName = "clientId",
            propertyValue = "checkingAcctFundTransferListener"),
        ...
        if (fundTransferDTO.getSourceAcctType().equals(AccountType.CHECKING)) {
            ...
            if (checkingAcctMgr.withdrawFunds(fundTransferDTO)) {
                try (KafkaConnection kafkaConnection
                    ...
                    kafkaConnection.send(new ProducerRecord("savingsacct-topic",
                            fundTransferDTOJson));
                } catch (Exception ex) {
                ...
                LOGGER.log(Level.WARNING, "There was a problem withdrawing funds, aborting transfer. ");
            }
